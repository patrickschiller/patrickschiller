...
* **Agentic AI & LLMs:** Building, training, and deploying custom LLMs and autonomous AI agents.
* **Scalable Architectures:** High-integrity, real-time ecosystems using **NestJS, React, and PostgreSQL**.
* **Cloud & Azure:** Certified Azure Architect designing scalable enterprise solutions and DevOps pipelines.
